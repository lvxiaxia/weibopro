...
//			   System.out.println(updatesql);
	...
	public static void insertMicroblogs(String uid, String mid, String time,String geo,String source,
		...
		if (uid == null)
			return;
		String sql = "insert into data2016.microblog2 values(\"" + mid+  "\",\"" + uid +  "\",\"" + time
				+  "\",\"" + geo+  "\",\"" + source +  "\",\"" +repost +  "\",\"" + comment +  "\",\"" + attitude
				+  "\",\"" + text+ "\"," + flag + ")";
		String selectsql = "select count(*) from data2016.microblog2 where uid = \""+ uid+ "\" and mid=\"" + mid + "\"";
...
//			System.out.println(sql);
	...
	public static void readUserMicroblogs() throws Exception{
		//0 1
		File file = new File("data/source/first/microblogs/microblogs2.txt");   
		BufferedInputStream fis = new BufferedInputStream(new FileInputStream(file));    
		BufferedReader reader = new BufferedReader(new InputStreamReader(fis,"utf-8"),5*1024*1024);// 用5M的缓冲读取文本文件  
